...
void manipulator_update_position_controller(manipulator_t *manipulator) {
    ...
    float u1 = p_term_q0 + i_term_q0 + d_term_q0 + manipulator->current_setpoint.dq0; // Use u0 for Joint 0
    float u2 = p_term_q1 + i_term_q1 + d_term_q1 + manipulator->current_setpoint.dq1; // Use Joint 1 calculation for Joint 1
